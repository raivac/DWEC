...
//bucle que irá pidiendo palabras hasta que se deje vacio o se cancele
do{
...
function Anagrama(array){
    //si se cancela no hara la función
    if(palabra!=null){
        ...
        const arrOrd = [];
        let letras;
        /*bucle  que separara los caracteres de cada string , los oredenara y los volvera a juntar,seguidamete lo             metera en un nuevo array*/
        ...
        if(cont==arrOrd.length){
            document.write("Las palabras introducidas son anagramas");
            return true;
        }
        else{
            document.write("Las palabras introducidas no son anagramas");
            return false;
        }
